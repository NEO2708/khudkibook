...
import 'me1model.dart';

class GetMe1Books extends StatefulWidget {
  final Me1items books;

  // ignore: unnecessary_null_comparison
  const GetMe1Books({super.key, required this.books}) : assert(books != null);

  @override
  State<GetMe1Books> createState() => _GetMe1BooksState();
}

class _GetMe1BooksState extends State<GetMe1Books> {
  @override
