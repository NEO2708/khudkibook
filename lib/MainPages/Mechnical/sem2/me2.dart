...
import 'package:khudkibook/MainPages/Mechnical/sem2/getme2.dart';
import 'package:khudkibook/MainPages/Mechnical/sem2/me2model.dart';
...
class _Me2HomePageState extends State<Me2HomePage> {
  ...
  loadData() async {
    final dataJson = await rootBundle.loadString("/Users/rangolivision/Desktop/code/final/khudkibook/assets/files/me/me2.json");
    final decodData = jsonDecode(dataJson);

    var productData = decodData["me2products"];
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                  onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: ((context) => GetMl2Books(books: books)),
                        ),
                      ),
