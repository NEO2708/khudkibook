...
class GetMe2Books extends StatefulWidget {
  final Me2items books;

  // ignore: unnecessary_null_comparison
  const GetMe2Books({super.key, required this.books}) : assert(books != null);

  @override
  State<GetMe2Books> createState() => _GetMe2BooksState();
}

class _GetMe2BooksState extends State<GetMe2Books> {
  @override
